...
namespace Persistence.Database.Migrations
{
    ...
    [Migration("20201119142919_AddTablesIdent")]
    partial class AddTablesIdent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Identity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "09288f91-f09a-4d36-9f64-b1e94f7bf2ac",
                            ConcurrencyStamp = "465270e3-0654-4e77-aafc-151808a7710b",
                            Name = "Admin",
                            NormalizedName = "Admin"
                        },
                        new
                        {
                            Id = "2f1a4dd6-69d8-4c27-b7e7-d806598c60bc",
                            ConcurrencyStamp = "c09de83b-506c-4f30-ac00-3682d29b082f",
                            Name = "Seller",
            ...
            modelBuilder.Entity("Model.Product", b =>
                {
                    b.HasOne("Model.Category", "Caterory")
                        .WithMany("Products")
